        ...
        <div className="max-w-3xl mx-auto text-center">
          ...
          >
            <h1 className="text-4xl sm:text-6xl md:text-8xl font-bold mb-6 md:mb-8 tracking-tight">
              ...
              <span
                className={cn(
                  "bg-clip-text text-transparent bg-gradient-to-r from-indigo-600 via-gray-900/90 to-rose-600"
                )}
              >
                {title2}
              </span>
          ...
          >
            <a
              href="/kontakt"
              className="px-8 py-3 rounded-full bg-gray-900 text-white font-medium text-sm hover:bg-gray-800 transition-colors"
            >
              Kostenloses Erstgespräch
            </a>
            <a
              href="#services"
              className="px-8 py-3 rounded-full border border-gray-200 text-gray-500 font-medium text-sm hover:bg-gray-50 transition-colors"
            >
              Unsere Services
            </a>
          </motion.div>
