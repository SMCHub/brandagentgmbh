  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 z-10 flex flex-col items-center justify-center text-white">
        ...
        <div className="text-center space-y-4 sm:space-y-6 max-w-5xl mx-auto px-4 sm:px-6">
          <div className="space-y-1 sm:space-y-2">
            <h1 className="text-3xl sm:text-5xl md:text-7xl lg:text-8xl font-bold bg-gradient-to-r from-orange-300 via-yellow-400 to-amber-300 bg-clip-text text-transparent leading-[1.1]">
              {headline.line1}
            </h1>
            <h1 className="text-3xl sm:text-5xl md:text-7xl lg:text-8xl font-bold bg-gradient-to-r from-yellow-300 via-orange-400 to-red-400 bg-clip-text text-transparent leading-[1.1]">
              {headline.line2}
            </h1>
          </div>

          <div className="max-w-3xl mx-auto">
            <p className="text-sm sm:text-lg md:text-xl lg:text-2xl text-orange-100/90 font-light leading-relaxed">
              {subtitle}
            </p>
          </div>
