...
const DEFAULT_MARKERS = [
  { lat: 47.17, lng: 8.52, label: "Steinhausen" },
  { lat: 37.78, lng: -122.42, label: "Zürich" },
  { lat: 51.51, lng: -0.13, label: "Bern" },
  { lat: 35.68, lng: 139.69, label: "St. Gallen" },
  { lat: -33.87, lng: 151.21, label: "Lugano" },
  { lat: 1.35, lng: 103.82, label: "Luzern" },
  { lat: 55.76, lng: 37.62, label: "Basel" },
  { lat: -23.55, lng: -46.63, label: "Genf" },
  { lat: 19.43, lng: -99.13, label: "Lausanne" },
  { lat: 28.61, lng: 77.21, label: "Chur" },
];
...
const DEFAULT_CONNECTIONS: {
  ...
  { from: [47.17, 8.52], to: [37.78, -122.42] },
  { from: [47.17, 8.52], to: [51.51, -0.13] },
  { from: [47.17, 8.52], to: [35.68, 139.69] },
  { from: [47.17, 8.52], to: [1.35, 103.82] },
  { from: [47.17, 8.52], to: [28.61, 77.21] },
  { from: [47.17, 8.52], to: [-23.55, -46.63] },
  { from: [47.17, 8.52], to: [55.76, 37.62] },
