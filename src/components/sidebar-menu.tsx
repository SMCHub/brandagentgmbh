...
const menuItems = [
  {
    ...
    subtitle: "Branding",
    items: [
      { label: "LLM Texte", href: "/leistungen/digitale-praesenz/llm-texte" },
      { label: "Leadgenerierung", href: "/leistungen/digitale-praesenz/leadgenerierung" },
      { label: "Ads Management", href: "/leistungen/digitale-praesenz/ads-management" },
      { label: "Webseiten Entwicklung", href: "/leistungen/digitale-praesenz/webseiten" },
      { label: "Webshop Entwicklung", href: "/leistungen/digitale-praesenz/webshops" },
    ],
  },
  {
    ...
    subtitle: "Agents",
    items: [
      { label: "Prozessautomatisierung", href: "/leistungen/automatisierung/prozessautomatisierung" },
      { label: "Vergleichsofferten", href: "/leistungen/automatisierung/vergleichsofferten" },
      { label: "Angebotsentwürfe", href: "/leistungen/automatisierung/angebotsentwuerfe" },
      { label: "Videoerstellung", href: "/leistungen/automatisierung/videoerstellung" },
    ],
  },
  {
  ...
  },
  {
    ...
    subtitle: "Portfolio",
    items: [
      { label: "hostagent.ch", href: "/referenzen/hostagent" },
      { label: "co-host.ch", href: "/referenzen/cohost" },
      { label: "nutshellai.ch", href: "/referenzen/nutshellai" },
    ],
  },
  {
    title: "Über uns",
